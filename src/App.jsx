        ...
        <div class="wrapper">
          ...
          <div class="slide four" id="cuatro">
            ...
            <div className="escritura">
              ...
              <div className="etapa">
                <img src="./borrador.png" alt="" className="w-[50%]" />
              ...
              <div className="etapa">
                <img src="./revision.png" alt="" className="w-[50%]" />
              ...
              <div className="etapa">
                <img src="./redaccion.png" alt="" className="w-[50%]" />
              ...
              <div className="etapa">
                <img src="./estilso.png" alt="" className="w-[50%]" />
              ...
              <div className="etapa">
                <img src="./proceso.png" alt="" className="w-[100%]" />
              </div>
            </div>
          </div>
          <div class="slide two" id="lectura">
          ...
          <div class="slide three" id="video">
            ...
            <div className="botones">
              <a href="https://www.youtube.com/watch?v=T3WJE1mgZs4&ab_channel=DiscosMusart" target="_blank">
                <img src="./caja.png" alt="" className="" />
